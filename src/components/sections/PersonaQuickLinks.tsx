...
const staticTabs: Tab[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { icon: 'FlaskConical', label: 'LPPM',       href: '/lppm/unit-penelitian' },
  ...
  },
  {
    ...
    links: [
      ...
      { icon: 'FileSignature', label: 'Pengajuan Akademik', href: 'https://app.sipekad.web.id/', external: true },
      { icon: 'Database', label: 'Repositori Riset',  href: '/lppm/publikasi' },
  ...
  },
  {
    ...
    links: [
      ...
      { icon: 'Atom', label: 'Riset Bersama',    href: '/lppm/unit-penelitian' },
