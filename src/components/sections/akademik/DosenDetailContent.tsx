  ...
  return (
    <div className="space-y-8">
          ...
          <div className="grid gap-6 lg:grid-cols-[9rem_minmax(0,1fr)] lg:gap-8">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-4 max-w-3xl text-sm font-medium leading-7 text-gray-600">
                Profil akademik dosen STTPU Jakarta yang aktif mengajar pada {dosen.programStudi.join(', ')} and
      ...
      <div className="space-y-8">
        ...
        {/* Academic Details & Bidang Keahlian in horizontal layout */}
        ...
        <SectionCard title="Program Studi Pengampu" eyebrow="Teaching Scope">
