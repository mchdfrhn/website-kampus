...
export default async function AkreditasiContent() {
  ...
  return (
    <article className="space-y-10 pt-10 sm:pt-12">
      ...
      <section className="rounded-2xl border border-gray-100 bg-gray-50 p-5 shadow-premium">
      ...
      <section>
        ...
        <div className="overflow-x-auto rounded-2xl border border-gray-100 bg-white shadow-premium">
      ...
      <section>
        ...
        <ul className="space-y-4" aria-label="Dokumen legalitas STTPU">
          {legalitas.map((item, idx) => (
            <li key={idx} className="flex items-start gap-4 rounded-2xl border border-gray-100 bg-white p-4 shadow-premium">
              <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-xl bg-brand-navy/10" aria-hidden="true">
