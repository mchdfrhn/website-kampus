...
export const AkademikPage: GlobalConfig = {
  ...
  fields: [
    ...
    },
    {
      ...
      type: 'group',
      label: 'Card Konsultasi Akademik (Bawah)',
      fields: [
        { name: 'title', type: 'text', label: 'Judul CTA' },
        { name: 'description', type: 'textarea', label: 'Deskripsi CTA' },
        { name: 'primaryLabel', type: 'text', label: 'Teks Tombol Utama' },
        { name: 'primaryHref', type: 'text', label: 'Link Tombol Utama' },
        { name: 'secondaryLabel', type: 'text', label: 'Teks Tombol Kedua' },
        { name: 'secondaryHref', type: 'text', label: 'Link Tombol Kedua' },
      ],
    },
  ],
}
