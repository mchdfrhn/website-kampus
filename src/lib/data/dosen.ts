...
export const dosenList: Dosen[] = [
  {
    ...
    bidangKeahlian: ['Rekayasa Struktur', 'Beton Prategang'],
  ...
  },
  {
    ...
    bidangKeahlian: ['Teknik Lingkungan', 'Kualitas Air'],
  ...
  },
  {
    ...
    nidn: '0010057201',
    jabatanFungsional: 'Lektor Kepala',
    pendidikanTerakhir: 'S3 Teknik Informatika — Institut Teknologi Bandung',
    bidangKeahlian: ['Data Science', 'Kecerdasan Buatan', 'Machine Learning'],
    programStudi: ['Teknik Informatika'],
    email: 'surya.darma@sttpu.ac.id',
    bio: 'Ahli kecerdasan buatan dengan keahlian khusus di bidang data science dan rekayasa perangkat lunak. Aktif dalam penelitian data mining untuk aplikasi industri.',
    publikasi: [
  ...
  },
  {
    ...
    nidn: '0018077501',
    jabatanFungsional: 'Lektor Kepala',
    pendidikanTerakhir: 'S3 Ilmu Komputer — Universitas Gadjah Mada',
    bidangKeahlian: ['Keamanan Siber', 'Rekayasa Perangkat Lunak', 'Cloud Computing'],
    programStudi: ['Teknik Informatika'],
    email: 'irwan.susanto@sttpu.ac.id',
    bio: 'Praktisi sekaligus akademisi di bidang teknologi informasi dengan pengalaman lebih dari 15 tahun sebagai software architect dan security analyst di berbagai industri digital di Indonesia.',
    publikasi: [
